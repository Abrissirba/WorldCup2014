    ...
    App.Model.Group = BaseModel.extend({
        ...
        getTable: function () {
            ...
            this.get("Games").each(function (game, idx, self) {
                ...
                if (game.get("userExcpectedHomeResult") !== null && game.get("userExcpectedAwayResult") !== null) {
                    HomeTeam.Games++;
                    AwayTeam.Games++;
                    HomeTeam.GoalsScored += game.get("userExcpectedHomeResult");
                    HomeTeam.GoalsConceded += game.get("userExcpectedAwayResult");
                    AwayTeam.GoalsScored += game.get("userExcpectedAwayResult");
                    AwayTeam.GoalsConceded += game.get("userExcpectedHomeResult");
                    isNaN(HomeTeam.GoalsPlusMinus) ? HomeTeam.GoalsPlusMinus = 0 : "";
                    isNaN(AwayTeam.GoalsPlusMinus) ? AwayTeam.GoalsPlusMinus = 0 : "";
                    HomeTeam.GoalsPlusMinus += game.get("userExcpectedHomeResult") - game.get("userExcpectedAwayResult");
                    AwayTeam.GoalsPlusMinus += game.get("userExcpectedAwayResult") - game.get("userExcpectedHomeResult");
                    if (game.get("userExcpectedHomeResult") > game.get("userExcpectedAwayResult")) {
                        HomeTeam.Victory++;
                        HomeTeam.Points += 3;
                    }
                    else if (game.get("userExcpectedHomeResult") === game.get("userExcpectedAwayResult")) {
                        HomeTeam.Draw++;
                        HomeTeam.Points += 1;
                        AwayTeam.Draw++;
                        AwayTeam.Points += 1;
